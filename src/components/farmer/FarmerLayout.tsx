...
import { LayoutDashboard, Search, FileText, Calendar, History, Star, User, LogOut, Tractor } from 'lucide-react';
...
export default function FarmerLayout() {
  ...
  const navItems = [
    ...
    { path: '/farmer/search', label: 'Search Equipment', icon: Search },
    { path: '/farmer/requests', label: 'My Requests', icon: FileText },
    { path: '/farmer/active-rentals', label: 'Active Rentals', icon: Calendar },
    { path: '/farmer/history', label: 'Rental History', icon: History },
    { path: '/farmer/feedback', label: 'Feedback', icon: Star },
        ...
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-4">
            <div className="bg-green-50 px-4 py-2 rounded-sm border border-green-200">
              <span className="text-sm font-medium text-green-900">Role: Farmer</span>
            </div>
            <button
