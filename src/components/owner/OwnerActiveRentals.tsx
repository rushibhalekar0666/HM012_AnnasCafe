  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600 mt-1">Currently rented equipment and rental details</p>
      </div>
      ...
      <div className="bg-green-50 border border-green-200 rounded-sm p-4 mb-6">
        <div className="flex items-center justify-between">
          <p className="text-sm text-green-900">
            <span className="font-semibold">{activeRentals.length}</span> equipment currently on rent
          </p>
          <p className="text-sm text-green-900">
            Total Value: <span className="font-semibold">₹16,400</span>
          </p>
        </div>
      </div>
                ...
                <tr key={rental.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="text-sm font-medium text-gray-900">{rental.farmer}</div>
                  ...
                  <td className="px-6 py-4 text-sm">
                    ...
                    >
                      {rental.remainingDays === 0 ? 'Ending Today' : `${rental.remainingDays} day(s)`}
                    </span>
                  </td>
